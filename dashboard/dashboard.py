...
polutan_utama, polutan_lainnya, korelasi_kecepatan_angin = sl.tabs(['Polutan Utama', 'Polutan Lainnya', 'Korelasi Kecepatan Angin'])

with polutan_utama:
    sl.header('Tren 2013-2017')
